...
Public Function GetNumDevice() As Integer
   GetNumDevice = midiOutGetNumDevs
End Function

Public Function GetVolume() As Long
   GetVolume = midiOutGetVolume(MIDIMAPPER, Volume)
End Function

Public Function SetVolume() As Long
   SetVolume = midiOutSetVolume(MIDIMAPPER, Volume)
End Function
